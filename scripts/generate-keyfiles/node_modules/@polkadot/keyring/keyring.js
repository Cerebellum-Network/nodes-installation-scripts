...
class Keyring {
  ...
  createFromJson({
    ...
    const encType = !Array.isArray(type) ? [type] : type; // Here the address and publicKey are 32 bytes and isomorphic. This is why the address field needs to be the public key for ethereum type pairs
  ...
  createFromUri(_suri, meta = {}, type = this.type) {
    ...
    const derived = type === 'ethereum' ? (0, _utilCrypto.hdEthereum)(seed, derivePath.substring(1)) : (0, _utilCrypto.keyFromPath)(keypairFromSeed[type](seed), path, type);
    return (0, _pair.createPair)({
      toSS58: this.encodeAddress,
      type
    }, derived, meta, null);
