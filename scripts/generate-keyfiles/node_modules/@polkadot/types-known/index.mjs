...
import typesChain from "./chain/index.mjs";
import typesModules from "./modules.mjs";
import typesSpec from "./spec/index.mjs";
import upgrades from "./upgrades/index.mjs";
export { packageInfo } from "./packageInfo.mjs"; // flatten a VersionedType[] into a Record<string, string>
