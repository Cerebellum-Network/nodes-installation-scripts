...
import { drr, refCountDelay } from "./util/index.mjs";
...
export class RpcCore {
  ...
  _createMethodSend(section, method, def) {
    ...
    const callWithRegistry = async (outputAs, values) => {
      ...
      const {
        registry
      } = hash && _classPrivateFieldLooseBase(this, _getBlockRegistry)[_getBlockRegistry] ? await _classPrivateFieldLooseBase(this, _getBlockRegistry)[_getBlockRegistry](hash) : {
