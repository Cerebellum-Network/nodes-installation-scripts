...
function extractDef(registry, _def) {
  ...
  if (isRustEnum(_def)) {
    def = Object.entries((0, _utils.mapToTypeMap)(registry, _def)).reduce((def, [key, Type], index) => {
      def[key] = {
        Type,
        index
      };
...
var _entryIndex = (0, _classPrivateFieldLooseKey2.default)("entryIndex");

var _indexes = (0, _classPrivateFieldLooseKey2.default)("indexes");

var _isBasic = (0, _classPrivateFieldLooseKey2.default)("isBasic");

var _isIndexed = (0, _classPrivateFieldLooseKey2.default)("isIndexed");
