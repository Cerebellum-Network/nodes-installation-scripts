...
class ChainSpecGenerator {
    ...
    private generatePalletBalances(spec, config) {
        ...
        const rootAccountBalance = config.network.total_supply - aliceBalance - totalGenesisValidatorsStake - totalNominatorsStake - totalValidatorsStake - totalGenesisCouncilsStake - treasuryStake;
